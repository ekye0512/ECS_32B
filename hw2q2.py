...
class UnorderedList:
    ...
    def convert(self):
        """
        This method should convert an instance of the Unordered List
        class to an ordinary Python list.
        Once implemented, you can use it for debugging other functions!
        """
...
# Remember that none of these functions print anything. If you actually want to see the result, save the returned value into a variable and then print that variable
# The results stated in the comments are assuming you don't change the lines below. Youare free to add any of your own tests, but your results will be different from  whais stated in the comments.
# Q1
